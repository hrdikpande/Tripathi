...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='news_scraper'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A production-ready news aggregation API',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'news_scraper.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
